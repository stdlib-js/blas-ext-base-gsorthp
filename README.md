...
```javascript
import gsorthp from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsorthp@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsorthp@v0.2.1-esm/index.mjs';
```
