...
```javascript
gsorthp = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsorthp@v0.3.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsorthp@v0.3.1-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gsorthp/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-gsorthp/actions/workflows/test.yml?query=branch:v0.3.1
